            ...
            <div className="min-h-screen py-8">
                <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-8 text-center">
                        ...
                        <h1 className="mb-2 text-3xl font-bold text-gray-900">Create New Trivia Game</h1>
                        <p className="text-lg text-gray-600">Design an engaging trivia experience for your players</p>
                    </div>
                    ...
                    <div className="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-xl">
                        ...
                        <div className="bg-gradient-to-r from-blue-500 to-purple-600 px-8 py-6">
                            ...
                            <p className="mt-1 text-sm text-blue-100">Fill in the basic information for your trivia game</p>
                        </div>
